 ...
 */
internal class DribbbleJsoupConverter private constructor() : Converter<ResponseBody, List<Shot>> {
  ...
  override fun convert(value: ResponseBody): List<Shot> {
    val shotElements = Jsoup.parse(value.string(), ENDPOINT)
  ...
  companion object {
    ...
    val INSTANCE = DribbbleJsoupConverter()
