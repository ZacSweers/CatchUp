 ...
 */
internal class GitHubTrendingJsoupConverter private constructor() : Converter<ResponseBody, List<TrendingItem>> {
  ...
  override fun convert(value: ResponseBody): List<TrendingItem> {
    return Jsoup.parse(value.string(), ENDPOINT)
        .select(".repo-list li")
  ...
  companion object {
    ...
    val INSTANCE = GitHubTrendingJsoupConverter()
