  ...
  private CharSequence recurseElement(Element element,
    ...
    switch (type) {
      ...
      case AUTOLINK:
        ...
        setSpan(
            builder,
            new TouchableUrlSpan(link, textView.getLinkTextColors(), textView.getHighlightColor()));
        break;
      case BLOCK_QUOTE:
      ...
      case HRULE:
        setSpan(
            builder,
            new HorizontalLineSpan(mOptions.mHruleColor, mHruleSize, mHruleTopBottomPadding));
        break;
      case IMAGE:
