...
val supportLibraries: Configuration = configurations.maybeCreate("supportImplementation")
fun DependencyHandler.supportImplementation(dependencyNotation: Any): Dependency {
  return add("supportImplementation", dependencyNotation)
}
...
dependencies {
  ...
  supportLibraries.dependencies.forEach {
    implementation(it)
