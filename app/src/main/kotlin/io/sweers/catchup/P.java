...
public final class P {
  ...
  /**
   * Initializer that takes a {@link Context} for resource resolution. This will retrieve default
   * shared preferences.
   */
  ...
  /**
   * Initializer that takes a {@link Context} for resource resolution. This will retrieve default
   * shared preferences if {@code autoCreateSharedPrefs} is true.
   */
  ...
  public static final void setSharedPreferences(
      final SharedPreferences sharedPreferences, @Nullable RxSharedPreferences rxPreferences) {
