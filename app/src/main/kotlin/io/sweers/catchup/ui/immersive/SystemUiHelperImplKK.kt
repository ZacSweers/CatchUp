...
internal class SystemUiHelperImplKK(activity: Activity,
    level: Int,
    flags: Int,
    onSystemUiVisibilityChangeListener: SystemUiHelper.OnSystemUiVisibilityChangeListener?) : SystemUiHelperImplJB(
