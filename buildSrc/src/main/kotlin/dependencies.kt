...
object deps {
  ...
  object android {
    ...
    const val gradlePlugin = "com.android.tools.build:gradle:3.6.0-alpha12"
  }
  ...
  object build {
    ...
    object gradlePlugins {
      const val bugsnag = "com.bugsnag:bugsnag-android-gradle-plugin:4.6.0"
  ...
  object misc {
    ...
    const val bugsnag = "com.bugsnag:bugsnag-android:4.20.0"
    const val byteunits = "com.jakewharton.byteunits:byteunits:0.9.1"

    object debug {
      private const val FLIPPER_VERSION = "0.25.0"
