...
object deps {
  ...
  object android {
    object androidx {
      const val annotations = "androidx.annotation:annotation:1.2.0-beta01"
      const val activity = "androidx.activity:activity:1.2.0-rc01"
    ...
    object firebase {
      ...
      const val database = "com.google.firebase:firebase-database:19.6.0"
  ...
  object build {
    ...
    object gradlePlugins {
      const val bugsnag = "com.bugsnag:bugsnag-android-gradle-plugin:5.7.1"
      const val playPublisher = "com.github.triplet.gradle:play-publisher:3.2.0"
      const val redacted = "dev.zacsweers.redacted:redacted-compiler-plugin-gradle:0.6.1"
  ...
  object kotlin {
    ...
    const val datetime = "org.jetbrains.kotlinx:kotlinx-datetime-jvm:0.1.1"
  ...
  object misc {
    ...
    const val bugsnag = "com.bugsnag:bugsnag-android:5.5.1"
    const val byteunits = "com.jakewharton.byteunits:byteunits:0.9.1"

    object debug {
      private const val FLIPPER_VERSION = "0.72.0"
    ...
    const val inboxRecyclerView = "me.saket:inboxrecyclerview:2.3.0"
    ...
    const val ticktock = "dev.zacsweers.ticktock:ticktock-android-lazyzonerules:1.0.0-2020d"
  ...
  object okhttp {
    const val bom = "com.squareup.okhttp3:okhttp-bom:4.10.0-RC1"
