...
object deps {
  ...
  object android {
    ...
    object build {
      // Upgrade to 29 when https://issuetracker.google.com/issues/139041608 is resolved
    ...
    const val gradlePlugin = "com.android.tools.build:gradle:3.6.0-alpha08"
  }
